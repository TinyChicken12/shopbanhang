                                ...
                                <div class="single-item">
                                    ...
                                    <div class="single-item-body">
                                        ...
                                        <p class="single-item-price">
                                            @if($new->unit_price == $new->promotion_price)
                                            <span style="font-size: 18px">{{number_format($new->unit_price)}} đồng</span>
                                            @else
                            ...
                            <div class="col-sm-3">
                                <div class="single-item">
                                    ...
                                    <div class="single-item-body">
                                        ...
                                        <p class="single-item-price">
                                            <span class="flash-del" style="font-size: 18px">{{number_format($spkm->unit_price)}} đồng</span>
                                            <span class="flash-sale" style="font-size: 18px">{{number_format($spkm->promotion_price)}} đồng</span>
                                        </p>
                                    </div>
                                    <div class="single-item-caption">
