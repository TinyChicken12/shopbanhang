                                ...
                                <div class="single-item">
                                    ...
                                    <div class="single-item-body">
                                        ...
                                        <p class="single-item-price">
                                            @if($sp->unit_price != $sp->promotion_price)
                                            <span class="flash-del" style="font-size: 18px">{{number_format($sp->unit_price)}} đồng</span>
                                            <span class="flash-sale" style="font-size: 18px">{{number_format($sp->promotion_price)}} đồng</span>
                                            @else
                                                <span class="flash-sale" style="font-size: 18px">{{number_format($sp->unit_price)}} đồng</span>
                                            @endif
                                        </p>
                                    </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="single-item">
                                        ...
                                        <div class="single-item-body">
                                            ...
                                            <p class="single-item-price">
                                                @if($sp_k->unit_price != $sp_k->promotion_price)
                                                    <span class="flash-del" style="font-size: 18px">{{number_format($sp_k->unit_price)}} đồng</span>
                                                    <span class="flash-sale" style="font-size: 18px">{{number_format($sp_k->promotion_price)}} đồng</span>
                                                @else
                                                    <span class="flash-sale" style="font-size: 18px">{{number_format($sp_k->unit_price)}} đồng</span>
                                                @endif
                                            </p>
                                        </div>
                                        <div class="single-item-caption">
